...
public class CommentController {
    ...
    public List<CommentResDTO> selectComment(@RequestBody HashMap<String, Object> map){
    ...
    public List<CommentResDTO> selectMyCommentList(@AuthenticationPrincipal LoginReqDTO user) {
    ...
    @PostMapping("/comment")
    public ResponseEntity<String> addComment(@AuthenticationPrincipal LoginReqDTO user, @RequestBody CommentReqDTO request) {
        return service.addComment(request, user);
    }
